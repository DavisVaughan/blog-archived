...
```{r, echo=FALSE}
blogdown::shortcode("youtube", id = "_u5k-Fk2bfU")
```
...
```{r, echo=FALSE}
blogdown::shortcode("youtube", id = "ihkLGPSkVMY")
```
...
```{r, echo = FALSE}
blogdown::shortcode("youtube", id = "6zY0qrcKTL0")
```
...
```{r, echo=FALSE}
blogdown::shortcode("youtube", id = "HqwSyy4bCDU")
```
...
```{r, echo=FALSE}
blogdown::shortcode("youtube", id = "43QxsQRluBQ")
```
